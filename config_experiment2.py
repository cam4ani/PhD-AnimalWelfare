...
#id of run
#this id should be changed each time you want to generate new results (i.e. be saving everyting without deleting what was already saved. Typically when you modify a function in the "utils.py" file and you would like to compare the results, OR when you use different dates for different purpose
id_run = 'VFGIven2Klara_' #'v1'
...
path_extracted_data = r'D:\vm_exchange\AVIFORUM\data\extracted_info_experiment2_VFVFVF'
...
date_min = dt.datetime(2019,10,22,0,0,0) #dt.datetime(2019,11,12,0,0,0)
date_max = dt.datetime(2020,7,29,23,59,59) #dt.datetime(2019,11,24,23,59,59)
